...
const cards = [
  ...
  {
    name: 'Leaderboard',
    description: 'The Leaderboard, running as an online platform, presents users as well as their individual scores, with the highest ranking user displayed at the top.',
    description2: "The score won't appear automatically upon submission; instead, data retrieval from the API will occur only when the Refresh button is clicked.",
    image: 'images/leader.png',
    languages: ['HTML', 'Bootstrap', 'Ruby'],
    seeLive: 'https://mryeminthu.github.io/Leaderboard/dist/',
    seeSource: 'https://github.com/mryeminthu/Leaderboard',
  },
  {
